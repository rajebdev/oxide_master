...
struct InstallationLogsView: View {
    let logs: [String]
        ...
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text("Real-time installation progress")
                        .font(.caption)
    ...
    private func logColor(for log: String) -> Color {
        if log.contains("✅") || log.contains("✓") || log.contains("Successfully") {
            ...
            return .orange
        } else if log.contains("🚀") || log.contains("📦") || log.contains("📥") || log.contains("🗑️") {
